...
class PAC(nn.Module):
    def __init__(
        ...
        self.hilbert = scitex_nn.Hilbert(seq_len, dim=-1, fp16=fp16)

        self.Modulation_index = scitex_nn.ModulationIndex(
            n_bins=18,
            fp16=fp16,
            amp_prob=amp_prob,
        )
    ...
    def init_bandpass(
        ...
        if not trainable:
            ...
            self.bandpass = scitex_nn.BandPassFilter(
                bands_all,
                fs,
                seq_len,
                fp16=fp16,
        ...
        # A trainable BandPassFilter specifically for PAC calculation. Bands will be optimized.
            ...
            self.bandpass = scitex_nn.DifferentiableBandPassFilter(
                seq_len,
                fs,
                fp16=fp16,
