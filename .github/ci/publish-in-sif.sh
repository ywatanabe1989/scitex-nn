...
# (project=scitex-nn, owner=ywatanabe1989, repo=scitex-nn,
...
TMPDIR="/tmp/publish-scitex_nn-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-nn dist/* uploaded to PyPI via manual OIDC trusted publishing"
