...
# Wavelet imports `from scitex_math import to_even` at module top,
# so it needs the real scitex_math package (no mocks — the source uses
# the standalone scitex_math after the parity-helpers standalonization).
pytest.importorskip("scitex_math")
import os
import tempfile
